...
**Updated:** 2026-04-21 · **Version:** 2.7 · **Total Items:** 82 · **Sprint 22 closed — B-030 reverted; drag foundation slips to S23**
...
```
Overall Progress    ████████████████░░░░  79% (65/82)  [0 in progress · S23 next]
```
...
⬜ B-009 — Drag-to-expand collapsed group · 🟡 · S [S23 — reverted from S22 after B-030 revert]
...
⬜ B-030 — Item drag-reorder within / between groups · 🟠 · L [S23 — re-architect v2 after S22 revert (perf + correctness)]
⬜ B-031 — Group drag-reorder & nesting via drag · 🟠 · M
⬜ B-032 — Auto-scroll during drag · 🟡 · S
⬜ B-033 — Drag saved+live item to Open Tabs → demote · 🟡 · S [S23 — reverted from S22 after B-030 revert]
